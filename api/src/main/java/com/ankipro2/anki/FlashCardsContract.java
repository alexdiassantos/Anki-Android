...
public class FlashCardsContract {
    public static final String AUTHORITY = "com.ankipro2.anki.flashcards";
    public static final String READ_WRITE_PERMISSION = "com.ankipro2.anki.permission.READ_WRITE_DATABASE";
