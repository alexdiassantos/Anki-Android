...
public class ImportDialog extends com.ankipro2.anki.dialogs.ImportDialog {
    private int mType = 0;
            ...
            case DIALOG_IMPORT_SELECT:
                ...
                if (fileList.size() == 0) {
                    UIUtils.showThemedToast(getActivity(),
                            getResources().getString(R.string.upgrade_import_no_file_found, "'.ankipro'"), false);
                    ...
                    for (int i = 0; i < tts.length; i++) {
                        if (fileList.get(i).getName().contains(".ankipro")){
                            tts[i] = fileList.get(i).getName().replace(".ankipro", "");
                        }else {
                    ...
                    return builder.title(res.getString(R.string.import_select_title))
                            ...
                            .itemsCallback(new MaterialDialog.ListCallback() {
                                ...
                                public void onSelection(MaterialDialog materialDialog, View view,
                                    ...
                                    if (filenameFromPath(importPath).equals("collection.ankipro")) {
