...
package com.ankipro2.anki.multimediacard.fields;
...
import com.ankipro2.anki.multimediacard.activity.LoadPronounciationActivity;
import com.ankipro2.anki.multimediacard.activity.PickStringDialogFragment;
import com.ankipro2.anki.multimediacard.activity.TranslationActivity;
...
public class BasicTextFieldController extends FieldControllerBase implements IFieldController,
    ...
    public void createUI(Context context, LinearLayout layout) {
        ...
        layout.addView(mEditText, LayoutParams.FILL_PARENT);
        ...
        LayoutParams p = new LayoutParams(0, LayoutParams.FILL_PARENT, 1);
    ...
    /*
     * (non-Javadoc)
     * @see com.ankipro2.anki.IFieldController#onActivityResult(int, int, android.content.Intent) When activity started
