...
import com.ankipro2.libanki.hooks.AdvancedStatistics;
import com.ankipro2.themes.Themes;
import com.ankipro2.ui.AppCompatPreferenceActivity;
import com.ankipro2.ui.SeekBarPreference;
...
import com.ankipro2.libanki.hooks.ChessFilter;
import com.ankipro2.libanki.hooks.HebrewFixFilter;
import com.ankipro2.libanki.hooks.Hooks;
import com.ankipro2.preferences.NumberRangePreference;
    ...
    private void initSubscreen(String action, PreferenceContext listener) {
        ...
        switch (action) {
            ...
            case "com.ankipro2.anki.prefs.custom_buttons":
                ...
                break;
            case "com.ankipro2.anki.prefs.advanced":
                ...
                customSyncServerPreference.setOnPreferenceClickListener(new OnPreferenceClickListener() {
                    public boolean onPreferenceClick(Preference preference) {
                        Intent i = CompatHelper.getCompat().getPreferenceSubscreenIntent(Preferences.this,
                                "com.ankipro2.anki.prefs.custom_sync_server");
                        startActivity(i);
                        return true;
                    }
                });
                ...
                advancedStatisticsPreference.setOnPreferenceClickListener(new OnPreferenceClickListener() {
                    public boolean onPreferenceClick(Preference preference) {
                        Intent i = CompatHelper.getCompat().getPreferenceSubscreenIntent(Preferences.this,
                                "com.ankipro2.anki.prefs.advanced_statistics");
                        startActivity(i);
                        return true;
                    }
                });
                ...
                break;
            case "com.ankipro2.anki.prefs.custom_sync_server":
                ...
                break;
            case "com.ankipro2.anki.prefs.advanced_statistics":
        ...
        try {
            ...
            switch (key) {
                ...
                case "providerEnabled": {
                    ComponentName providerName = new ComponentName(this, "com.ankipro2.anki.provider.CardContentProvider");
