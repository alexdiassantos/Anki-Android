...
import com.ankipro2.compat.customtabs.CustomTabActivityHelper;
import com.ankipro2.compat.customtabs.CustomTabsFallback;
import com.ankipro2.compat.customtabs.CustomTabsHelper;
    ...
    */
    ...
    public void updateWidgetDimensions(Context context, RemoteViews updateViews, Class<?> cls) {
        ...
        for (int id : ids) {
            ...
            updateViews.setViewPadding(R.id.ankipro_widget_text_layout, horizontal, vertical, horizontal, vertical);
        }
    }
    ...
    public Uri getExportUri(Context context, File file) {
        ...
        return FileProvider.getUriForFile(context, "com.ankipro2.anki.apkgfileprovider", file);
    }
}