...
public class CompatV11 extends CompatV10 implements Compat {
    ...
    public Intent getPreferenceSubscreenIntent(Context context, String subscreen) {
        Intent i = new Intent(context, com.ankipro2.anki.Preferences.class);
        i.putExtra(PreferenceActivity.EXTRA_SHOW_FRAGMENT, "com.ankipro2.anki.Preferences$SettingsFragment");
